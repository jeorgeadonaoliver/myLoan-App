...
<aside class=" bg-gray-800 text-white shadow-lg z-50 w-full py-2 flex flex-row justify-around items-center sm:w-full sm:h-auto 
    ...
    <nav class="w-full">
        <ul class="flex flex-row justify-around md:flex-col md:justify-start list-none md:space-y-4">
            ...
            <li class="hover:bg-gray-700 transition-colors duration-200">
                <a [routerLink]="['/app/dashboard', email()]" class="block py-4 text-center text-xl" title="home">
            ...
            <li class="hover:bg-gray-700 transition-colors duration-200">
                <a [routerLink]="['/app/dashboard', email()]" class="block py-4 text-center text-xl" title="Profile">
            ...
            <li class="hover:bg-gray-700 transition-colors duration-200">
                <a [routerLink]="['/app/loanrequest']" class="block py-4 text-center text-xl" title="Settings">
    ...
    <nav class="w-full">
        <ul class="flex flex-row justify-around md:flex-col md:justify-start list-none md:space-y-4">
            <li class="hover:bg-gray-700 transition-colors duration-200">
                <a [routerLink]="['/app/profile']" routerLinkActive="router-link-active" class="block py-4 text-center text-xl" title="Profile">
